...
#include <cmath>
#include <iostream>
Bullet::Bullet(const glm::vec2& pos, const glm::vec2& dir, ShaderProgram* shaderProgram, BulletType type)
{
    if(type == BulletType::GUARD) {
        texture.loadFromFile("images/guardBullet.png", TEXTURE_PIXEL_FORMAT_RGBA);
    } 
    else {
